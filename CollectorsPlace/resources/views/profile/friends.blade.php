@extends('layout')
@section('content')
    <script>document.title = "Collectors Place | Követések"</script>
    @if($errors->any())
            ...
            <div class="col-7 col-md-6 col-lg-4">
                <div class="card mt-3" style="width: 18rem">
                    <div class="card-body text-center mt-2">
                        ...
                        <div>
                            <h5 class="card-title" style="display: inline-block">{{$adat->user_username}}</h5>
    ...
    <div class="unclickable" id="unclickable">
    </div>
    <div class="popup" id="popup">
        <div class="xbutdiv">
            <button type="button" onclick="closePopup()" class="xbut">❌</button>
        </div>
        <h3 id="szovegNevvel">Értékelje ezt a felhasználót: !</h3>
